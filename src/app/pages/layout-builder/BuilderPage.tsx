        ...
        <div className='card-body d-flex align-items-center py-8'>
          ...
          <div className='ms-6'>
            <p className='list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0'>
              ...
              folder since the layout builders main purpose is to help to generate the final HTML
              code without hassle. Layout builder changes dont affect pages with layout wrappers.
            </p>
          </div>
          {/* end::Description */}
        </div>
