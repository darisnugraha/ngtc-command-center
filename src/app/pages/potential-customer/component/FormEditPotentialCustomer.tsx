...
const FormEditPotentialCustomer: React.FC<InjectedFormProps<{}, Props>> = (props: any) => {
    ...
    <form onSubmit={handleSubmit}>
      <div className='row'>
        ...
        <div className='col-lg-6'>
          <Field
            ...
            onChange={(e: any) => {
              dispatch(
                change('FormEditPotentialCustomer', 'correspondence_address', e.target.value)
              );
            }}
          />
        </div>
      ...
      <div className='row justify-content-end mt-5'>
        <div className='col-lg-3 d-grid'>
          <SubmitButton title='Edit Data' imagePath='' />
        </div>
      </div>
    </form>
  );
...
const form = reduxForm<{}, Props>({
  ...
  form: 'FormEditPotentialCustomer',
  touchOnChange: true,
