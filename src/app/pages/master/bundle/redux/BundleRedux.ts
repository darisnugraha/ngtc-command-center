...
export const actions = {
  ...
  handleGetDetailProduct: (id: string) => {
    return async (
      ...
      if (data === 'SOFTWARE') {
        AxiosGet('product/by-kode', { params: { kode_produk: id } }).then((res: any) => {
        ...
        AxiosGet('hardware/by-kode', { params: { kode_hardware: id } }).then((res: any) => {
          const dataDecrypt = doDecryptData(res.data[0], [
            'kode_hardware',
            'kode_supplier',
            'status',
        ...
        AxiosGet('consumable/by-kode', { params: { kode_consumable: id } }).then((res: any) => {
          const dataDecrypt = doDecryptData(res.data[0], [
            'kode_consumable',
            'kode_supplier',
            'status',
