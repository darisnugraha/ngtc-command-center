...
export const actionTypes = {
  GetListPaymentOC: '[PAYMENTOC] Get Data List Payment OC',
  GetListPaymentOCDP: '[PAYMENTOC] Get Data List Payment OC DP',
  ShowModalPaymentOC: '[PAYMENTOC] Show Modal Payment OC',
...
export const reducer = persistReducer(
  { storage, key: 'v100-demo1-payment-order-confirmation', whitelist: ['isSending'] },
