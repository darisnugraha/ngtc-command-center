...
const DeliveryReportPDF = (data, head) => {
  ...
  tableColumn = [
    [
      { content: `No` },
      { content: `No Delivery Order` },
      { content: `No Order Confirmation` },
      { content: `Delivery Order Date` },
      { content: `Store Code` },
      { content: `Branch Code` },
  ...
  data.forEach((element) => {
    const row = [
      { content: no++ },
      { content: element.no_surat_jalan },
      { content: element.no_order_konfirmasi },
      { content: element.tanggal_surat_jalan },
